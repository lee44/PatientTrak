...
$charges = mysqli_fetch_array($result);
        ...
        <form form name = "form1" action="update_payment.php" method = "POST" enctype = "multipart/form-data" >
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    echo '
                    <tr class="d-flex">
                        <td class="col-3"><input type="date"   class="form-control"        name="created_at[]" value="'.$charges['charge_created_at'].'" required></td>
                        <td class="col-3"><input type="text"   class="form-control"        name="charge_description[]" value="'.$charges['charge_description'].'" required></td>
                        <td class="col-2"><input type="number" class="form-control charge" name="charge[]" step="any" min="0" max="1000" value="'.$charges['charge'].'" required></td>
                        <td class="col-4"><input type="text"   class="form-control"        name="charge_note[]" value="'.$charges['charge_note'].'"></td>
                    </tr>'
                    ?>
                </tbody>
            </table> 
            <table class="table">
                <tbody>
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-2">
                            <input type="text" id="subtotal" class="form-control" name="subtotal" readonly value="$'.$charges['subtotal'].'">
                        </td>
                    </tr>
                    <tr class="d-flex">
                        <td class="col-3"></td>
                        <td class="col-7 misc_label">CO PAY</td>
                        <td class="col-2"><input type="number" id="co_pay" class="form-control charge" name="co_pay" step="any" min="0" max="1000" value="'.$charges['co_pay'].'"></td>
                    </tr>
                    <tr class="d-flex">
                        <td class="col-3"></td>
                        <td class="col-7 misc_label">TAXES</td>
                        <td class="col-2"><input type="number" id="taxes" class="form-control charge" name="tax" step="any" min="0" max="1000" value="'.$charges['tax'].'"></td>
                    </tr>
                    <tr class="d-flex">
                        <td class="col-3"></td>
                        <td class="col-7 misc_label">TOTAL</td>
                        <td class="col-2">
                            <input type="text" id="total_charges" class="form-control" name="total_charge" readonly value="$'.$charges['total_charge'].'">
                        </td>
                    </tr>';
                    ?>
                </tbody>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    echo '
                    <tr class="d-flex">
                        <td class="col-3"><input type="date"   class="form-control"        name="payment_created_at[]" value="'.$payments['payment_created_at'].'" required></td>
                        <td class="col-3"><input type="text"   class="form-control"        name="payment_type[]" maxlength="11" value="'.$payments['payment_type'].'"></td>
                        <td class="col-2"><input type="number" id="payment" class="form-control charge" name="payment[]" step="any" min="0" max="10000" value="'.$payments['payment'].'"></td>
                        <td class="col-4"><input type="text"   class="form-control"        name="payment_note[]" value="'.$payments['payment_note'].'"></td>
                    </tr>';
                    ?>                 
                </tbody>
            </table>
            <table class="table">
                <tbody>
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-2">
                            <input type="text" id="total_payment" class="form-control" name="total_payment" readonly value="$'.$payments['total_payment'].'">
                        </td>
                    </tr>
                    <tr class="d-flex">
                        <td class="col-3"></td>
                        ...
                        <td class="col-2">
                            <input type="text" id="balance" class="form-control" name="balance" readonly value="$'.$payments['balance'].'">
                        </td>
                    </tr>';
                    ?>
                </tbody>
